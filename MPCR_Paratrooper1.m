...
for i=1:11
    ...
    onesdigit(i)=sum(sum(onesplace==digits(:,:,i)))/length(onesplace(:));
    tensdigit(i)=sum(sum(tensplace==digits(:,:,i)))/length(tensplace(:));
